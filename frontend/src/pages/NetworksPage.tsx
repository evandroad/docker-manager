...
export default function NetworksPage() {
  ...
  return (
    ...
    <div className="mb-3 flex items-center gap-2">
      <button className="px-3 py-1.5 text-sm bg-blue-900/80 border-none rounded-md text-white cursor-pointer hover:bg-blue-800/80" title="Create a new network" onClick={() => setShowCreate(true)}>
